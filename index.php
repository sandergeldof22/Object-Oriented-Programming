...
<?php
    ...
    print('<br>');
    print($pokemonC->name . " is taking " . $pokemonP->attackEnemy($pokemonC, 'ElectricRing') . " damage");
    print('<br>');        
    ...
    print('<br>');
    print($pokemonP->name . " is taking " . $pokemonC->attackEnemy($pokemonP, 'Headbutt') . " damage");
    print('<br>');        
    ...
    print('<br>');
    print($pokemonC->name . " is taking " . $pokemonP->attackEnemy($pokemonC, 'PikaPunch') . " damage");
    print('<br>');        
    print($pokemonC->name . " now has " . $pokemonC->health . " health left");
    print('<br>');   
    ...
    print('<br>');
    print($pokemonP->name . " is taking " . $pokemonC->attackEnemy($pokemonP, 'Flare') . " damage");
    print('<br>');        
    print($pokemonP->name . " now has " . $pokemonP->health . " health left");
    print('<br>');  
